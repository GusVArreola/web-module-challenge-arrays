...
function copy(originalFlavors){
  const copyOriginal = [...originalFlavors];
  return (copyOriginal);
...
function addFlavor(originalFlavors, flavorTown){
  originalFlavors.unshift(flavorTown);
...
function removeFlavorByName(originalFlavors, string){
  originalFlavors.splice(originalFlavors.indexOf(string),1);
  return originalFlavors
}
